package org.sunger.lib.http.download.handler;

import java.text.DecimalFormat;

import org.sunger.lib.http.utils.FileUtils;
...
public abstract class DownloadHandler extends Handler {
	...
	private void sendSpeedMessage(long used_time, int length) {
		...
		sendMessage(obtainMessages(MESSAGE_SPEED, new Object[] { speedStr }));
	}
	...
	public void sendStartMessage(String fileName, String tempName,
			int globalCompelete, int fileSise) {
